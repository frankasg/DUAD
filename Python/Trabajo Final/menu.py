...
def get_student_info(student_info):
    name = get_name_info()
    ...
    student_info_to_dictionary(student_info, [name, section, spanish_grade, english_grade, social_grade, science_grade, average_value])
