...
from common.operations_util import generate_average, to_dict_list
...
def export_csv(students : list, headers: list):
    ...
    students_dict_list  = to_dict_list(students)
...
def import_students_from_csv():
    try:
        ...
        students = [Student(**data) for data in imported_students]
